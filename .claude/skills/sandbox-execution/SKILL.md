...
3. **Use root `.venv`** only for **`.forge/scripts/`** and **`requirements-forge.txt`** per **`.cursor/rules/python-runtime.mdc`** / **`/init`** — not for the application you are building.
...
* **`.cursor/rules/sandbox-projects.mdc`** — full policy
