...
* Repeatable automation implemented only as ephemeral terminal snippets instead of `/.forge/scripts/` when the step is deterministic and reused (see `rules/forge-scripts.mdc`)
